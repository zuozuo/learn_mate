...
class TestConversationService:
    ...
    @pytest.mark.asyncio
    async def test_create_conversation_without_message(
        self,
        session: Session,
        test_user: User
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_conversations_with_message_count(
        self,
        session: Session,
        test_user: User
    ):
    ...
    @pytest.mark.asyncio
    async def test_add_message_unauthorized(
        self,
        session: Session,
        test_user: User,
        test_conversation: Conversation
    ...
    @pytest.mark.asyncio
    async def test_auto_update_title_on_first_message(
        self,
        session: Session,
        test_user: User
    ):
...
class TestEnhancedChatService:
    ...
    async def test_create_temporary_conversation(
        ...
        conv_id = await service.create_temporary_conversation(
            user_id=test_user.id,
            first_message="Legacy message"
        )
