    ...
    try:
        ...
        async for event in self._graph.astream_events(
            ...
            # Log other events for debugging
                ...
                logger.debug(
                    "streaming_event", session_id=session_id, event_type=event["event"], token_count=token_count
                )
        ...
        logger.error("token_streaming_error", session_id=session_id, error=str(e), tokens_before_error=token_count)
        raise e
...
async def get_direct_stream_response(
    ...
    try:
        ...
        logger.error("direct_streaming_error", session_id=session_id, error=str(e))
        raise e
