    ...
    try:
        ...
        if accumulated_content and self._graph:
            try:
                ...
                logger.info("streaming_history_saved", session_id=session_id, content_length=len(accumulated_content))
        ...
        logger.error("direct_streaming_error", error=str(e), session_id=session_id)
        raise e
